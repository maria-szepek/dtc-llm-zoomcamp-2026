...
"""
Instead of using a dictionary and carrying it around, it is very clear for me
what is inside each field and every time we will capture a new record 
we will conveniently use this class.
"""
...
# RAGWithMetrics is extended RAGBase which we've been carrying around
